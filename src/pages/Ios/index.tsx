      ...
      <GridColDescription>
        <StepTitle>
          ...
          <DownloadAppButton
            ...
            dimension="small"
            url={appSettings.LINK_APP_IOS_URL}>
            Скачать приложение
          </DownloadAppButton>
        </StepTitle>
      </GridColDescription>
...
function StepSecond() {
  return (
    <GridStep>
      <GridColDescription>
        <StepTitle>2. Подтвердите установку</StepTitle>
        <Description>Появится предупреждающий поп-ап, выберите «Установить».</Description>
      </GridColDescription>
      <GridCol>
        <Image src={screen2} />
      </GridCol>
...
function StepThird() {
  return (
    <GridStep>
      <GridColDescription>
        <StepTitle>3. Установка началась</StepTitle>
        <Description>На главном экране телефона вы увидите, когда она закончится.</Description>
      </GridColDescription>
      <GridCol>
        <Image src={screen3} />
      </GridCol>
...
function StepFour() {
  return (
    <GridStep>
      <GridColDescription>
        <StepTitle>4. Перейдите в настройки телефона</StepTitle>
        <Description>
          «Основные» → «Профили и управл. устройством» → Bank GPB.AO
          <br /> <br />
        </Description>
        <Image src={screen4} />
        <Image src={screen4_1} />
...
function StepFive() {
  return (
    <GridStep>
      <GridColDescription>
        <StepTitle>5. Нажмите «Доверять BANK GPB,AO»…</StepTitle>
      </GridColDescription>
      <GridCol>
        <Image src={screen5} />
      </GridCol>
...
function StepSix() {
  return (
    <GridStep>
      <GridColDescription>
        <StepTitle>6. … и еще раз «Доверять».</StepTitle>
      </GridColDescription>
      <GridCol>
        <Image src={screen6} />
      </GridCol>
