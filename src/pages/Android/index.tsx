  ...
  return (
    <GridStep>
      <GridColDescription>
        ...
        <Description>
          Появится предупреждение, что
          приложение может нанести вред
          вашему устройству. Не
          волнуйтесь, все идет по плану.
          Нажмите «Ок».
        </Description>
      </GridColDescription>
      <GridCol>
  ...
  return (
    <GridStep>
      <GridColDescription>
        ...
        <Description>
          …и следом «Установить». Когда
          установка закончится,
          приложение будет готово к
          работе.
        </Description>
      </GridColDescription>
      <GridCol>
    ...
    <GridStep>
      <GridColDescription>
        ...
        <Description>
          ...
          раз, приложение попросит
          разрешение совершать звонки и
          управлять ими. Нажмите
          «Разрешить».
          <br /> <br />
